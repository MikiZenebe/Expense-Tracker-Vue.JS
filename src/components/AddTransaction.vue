...
<template>
  <div class="flex flex-col gap-2">
    <h3 class="text-md font-semibold text-white pt-3 border-b-2">
      Add Transaction
    </h3>
    <div class="flex flex-col gap-1">
      ...
      <button
        class="bg-green-600 mt-6 p-1.5 text-white rounded-md hover:bg-white hover:text-green-500 transition ease-in"
      >
        Add Transaction
      </button>
    </div>
